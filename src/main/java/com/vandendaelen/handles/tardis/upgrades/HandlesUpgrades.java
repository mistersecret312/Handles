...
public class HandlesUpgrades {
    ...
    public static final RegistryObject<UpgradeEntry> APRIORITRON = UPGRADES.register("aprioritron", () ->  new UpgradeEntry(AprioritronUpgrade::new, HandlesItems.APRIORITRON.get(), EnumSubsystemType.DEMAT));
}
